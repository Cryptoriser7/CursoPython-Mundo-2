...
valor = float(input('€: '))
print()
print('Agora selecione um dos metodos de pagamento de 1 a 4')
...
if metodo == 1:
    ...
    if conf1 == 'S':
        ...
        print('Voce nao concordou com o metodo de pagamento. Fechando')
    else:
        print('Responta nao reconhecida. Fechando')
    ...
    if conf2 == 'S':
        ...
        print('Resposta nao reconhecida. Fechando')
    ...
    if conf4 == 'S':
        ...
        print('Voce nao concordou com pagamento. Fechando')
    else:
        print('Resposta nao reconhecida. Fechando')

else:
    print('Metodo nao identificado, por favor tente novamente de 1 a 4')
print()
